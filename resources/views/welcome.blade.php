...
<body class="bg-gray-50 text-slate-800">
    ...
    <nav class="bg-white/80 backdrop-blur-md border-b border-gray-100 fixed w-full z-50 top-0 start-0">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <span class="self-center text-2xl font-bold whitespace-nowrap text-slate-900">Barber<span class="text-amber-500">Shoppe.</span></span>
        </a>
        <div class="flex md:order-2 space-x-3 md:space-x-4 rtl:space-x-reverse">
             ...
             @else
                ...
                <a href="{{ route('register') }}" class="text-white bg-amber-500 hover:bg-amber-600 focus:ring-4 focus:outline-none focus:ring-amber-300 font-bold rounded-lg text-sm px-5 py-2.5 text-center transition-all shadow-md shadow-amber-500/20">Get Started</a>
             @endauth
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
          <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent">
            <li>
              <a href="#" class="block py-2 px-3 text-white bg-amber-500 rounded md:bg-transparent md:text-amber-500 md:p-0" aria-current="page">Home</a>
            </li>
            <li>
              <a href="#features" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-amber-500 md:p-0 transition-colors">Features</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <section class="min-h-screen flex items-center justify-center pt-20 relative overflow-hidden">
        ...
        <div class="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
            <div class="absolute -top-[20%] -right-[10%] w-[50%] h-[50%] rounded-full bg-amber-200/20 blur-3xl"></div>
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
            <h1 class="mb-4 text-5xl font-extrabold tracking-tight leading-none text-slate-900 md:text-6xl lg:text-7xl animate-fade-in-up" style="animation-delay: 0.1s;">
                The Modern Way to <br class="hidden md:block"/> Manage Your <span class="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-orange-600">Shop.</span>
            </h1>
            ...
            <div class="mt-12 text-sm text-slate-500 flex flex-col items-center gap-2 animate-fade-in-up" style="animation-delay: 0.4s;" id="demo">
                ...
                <a href="{{ url('/book/joes-cuts') }}" target="_blank" class="text-amber-600 hover:text-amber-700 font-semibold underline decoration-amber-300 decoration-2 underline-offset-4 hover:decoration-amber-500 transition-all">
    ...
    <section id="features" class="bg-white py-24">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div class="p-8 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-lg hover:border-amber-200 transition-all duration-300 group">
                    <div class="flex justify-center items-center mb-4 w-12 h-12 rounded-xl bg-amber-100 group-hover:bg-amber-500 transition-colors duration-300">
                        <svg class="w-6 h-6 text-amber-600 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                    </div>
    ...
    <footer class="bg-slate-900 text-white py-12">
        <div class="max-w-screen-xl mx-auto px-4 text-center">
            <span class="text-2xl font-bold whitespace-nowrap text-white">Barber<span class="text-amber-500">Shoppe.</span></span>
            <p class="mt-4 text-slate-400">© {{ date('Y') }} BarberShoppe Inc. All rights reserved.</p>
        </div>
    </footer>
