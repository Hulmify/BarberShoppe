...
<body class="bg-[#fafafa] text-slate-900 min-h-screen">
    ...
    <div class="w-full max-w-3xl mx-auto px-4 pt-16 sm:pt-10">
        ...
        <form id="bookingForm" onsubmit="submitBooking(event)" class="space-y-6">
            ...
            <div id="footer" class="fixed bottom-0 left-0 z-50 w-full bg-white border-t border-gray-100 shadow-[0_-12px_45px_rgba(0,0,0,0.12)] transition-all duration-300 inactive mb-1">
    ...
    <script>
        ...
        async function fetchSlots() {
            ...
            // Show Loader
            noSlotsMsg.innerHTML = '<p class="text-sm font-bold uppercase tracking-widest opacity-50">Checking for slots...</p>';
