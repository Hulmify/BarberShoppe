...
@section('header', $stylist->name . ' Availability')
@section('subheader', 'Set working hours for this specific stylist.')

@section('content')

<div class="mb-4">
    <a href="{{ route('admin.stylists.index') }}" class="text-primary-600 hover:text-primary-700 font-medium flex items-center transition-colors">
        <svg class="w-4 h-4 me-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
        Back to Stylists
    </a>
</div>

<div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
    <form action="{{ route('admin.stylists.update_availability', $stylist) }}" method="POST">
        @csrf
        @method('PUT')
